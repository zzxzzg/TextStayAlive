 ...
 */
package com.guardz.alive.iogame.external.hook;
 ...
 */
@Slf4j
public class AliveUserHook implements UserHook, UserSessionsAware, BrokerClientAware {
    ...
    public void quit(UserSession userSession) {
        ...
        // 房间主路由和房间子路由（退出房间）
        int mergeCmd = CmdKit.merge(UserLoginCmd.cmd, UserLoginCmd.loginOut);
